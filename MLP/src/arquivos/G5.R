...
rm(list=ls(all=TRUE))
data<-read.table("G5 - Base_Simulacao.txt")
...
model <- mlp(heart$inputsTrain, heart$targetsTrain, size = 3,learnFunc="Quickprop",
             learnFuncParams = 0.1, maxit = 2000, inputsTest = heart$inputsTest, 
